...
# 0) Inputs
# -----------------
focal_genome <- "Etna_2" # Your focal accession name
pangenome <- readRDS("pangenome_matrix.rds")
...
ggsave(file.path("pangenome_frequency_plot.pdf"), width = 10, height = 6)
...
# -----------------
# Part 6 of the code to create the two plots "Gene composition by accession" and "Gene Composition With Percentages" was coded and shared by Luis Ansorge (Github: luisansorge)
# 
...
ggsave(file.path("gene_composition_by_accession.pdf"), width = 10, height = 6)
...
ggsave(file.path("gene_composition_with_percentages.pdf"), width = 10, height = 6)